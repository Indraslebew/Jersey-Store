...
<body>
    ...
    <header>
        ...
        <div class="slider">
            <img class="mySlides" src="main.hpg" style="width:100%;height: 500px;object-fit: cover;">
            <img class="mySlides" src="we3.png" style="width:100%;height: 500px;object-fit: cover;">
    ...
    <main>
        ...
        <?php  
            include "config.php";  // Assuming this file includes your database connection logic
            ...
            while ($data = mysqli_fetch_array($sql)) {
                ...
                echo "<img src='images/" . $data['gambar_produk'] . "' width='100%' height='300px' style='object-fit:cover;object-position:center;'>";
                echo "<div class='nama_brg'><p>" . $data['nama_produk'] . "</p></div>";
                echo "<div class='harga_brg'><p>Rp. " . $data['harga_produk'] . "(" . $data['stok_produk'] . ")</p></div>";
